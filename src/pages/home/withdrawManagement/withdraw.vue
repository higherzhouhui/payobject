...
<template>
  <div class="user_withdrawmanagement_withdraw_contianer">
    ...
    <div class="content flex">
      <div class="left">
        <div class="title">1、{{ $t("tczhybz") }}</div>
        <div class="content_shadow">
          <el-form label-position="top">
            <el-form-item :label="$t('tczh')">
              <el-select
                class="form-item"
                v-model="value"
                :placeholder="$t('xztcz')"
      ...
      <div class="right">
        <div class="title">2、{{ $t("txddxx") }}</div>
        <div class="content_shadow">
          <el-form :rules="rules">
            ...
            <div class="move">
              <div class="flex" style="gap: 20px">
                ...
                <div>
                  <div class="txt">{{ $t("tcje") }}</div>
                  <el-input class="form-item-3" :placeholder="$t('srtcje')" />
                </div>
              </div>
              <img
                class="frame"
            ...
            <el-form-item :label="$t('tkfy')" class="mt30" prop="type">
              <el-input class="form-item-1" :placeholder="$t('xztkfy')" />
            </el-form-item>
          </el-form>
          <div class="bottom">
