        ...
        <div class="container" ref="container">
            <div class="banner">
                <div class="container-auto banner-content">
                    <div class="left leftAni">
                        ...
                        <div class="btn-group">
                            <div  class="normal-btn start-btn" @click="handleNext">{{$t("start")}}</div>
                    ...
                    <div class="right">
                        ...
                        <div class="normal-btn pro-btn" @click="handleNext">{{$t("proceed")}}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="allpayment-content">
                <div class="container-auto allpay-desc">
                    ...
                    <div class="normal-btn opennew-btn" @click="$router.push('/user/register')">{{$t("opennew")}}</div>
                </div>
            </div>
            <div class="animation-warapper have-bg">
                <div class="container-auto section-content animation">
